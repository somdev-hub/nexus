...
import com.nexus.pms.payload.ActivityLogDto;
import com.nexus.pms.util.Logger;
            ...
            if (result instanceof ResponseEntity<?>) {
                ...
                if (response.getBody() != null) {
                    try {
                        ...
                        if (response.getBody() instanceof Payment user) {
                            activityLog.setUserId(user.getPaymentId());
                        }
