...
public class AnalyticsServiceImpl implements AnalyticsService {
	...
	public ResponseEntity<?> getEmployeeAvgStrength(Long orgId) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(webConstants.getEmployeeAveStrengthUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				return ResponseEntity.ok(response.getBody());
			} else {
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch employee average strength");
			}
	...
	public ResponseEntity<?> getLeaveTypeDistribution(Long orgId, String monthYear) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromUriString(webConstants.getLeaveTypeDistributionUrl())
			...
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch leave type distribution");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getEmployeeCheckInCheckOut(Long orgId, String monthYear) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromUriString(webConstants.getEmployeeCheckInCheckOutUrl())
					.queryParam("orgId", orgId).queryParam("monthYear", monthYear);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody()
								: "Failed to fetch employee check-in/check-out data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getEmployeeBreakStartEnd(Long orgId, String monthYear) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromUriString(webConstants.getEmployeeBreakStartEndUrl())
					.queryParam("orgId", orgId).queryParam("monthYear", monthYear);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody()
								: "Failed to fetch employee break start/end data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getPayrollYearly(Long orgId) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(webConstants.getPayrollYearlyUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody() : "Failed to fetch payroll yearly data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getPayrollRoleWise(Long orgId) {
		...
		try {
			...
			UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(webConstants.getPayrollRoleWiseUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), roleEmpIdMap, null,
					HttpMethod.POST, null);
			if (response.getStatusCode().is2xxSuccessful()) {
				return ResponseEntity.ok(response.getBody());
			} else {
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch payroll role-wise data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getOvertimeAnomaly(Long orgId) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(webConstants.getOvertimeAnomalyUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch overtime anomaly data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getLeavesDepartmentWise(Long orgId, String monthYear) {
		...
		try {
			...
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody()
								: "Failed to fetch leaves department-wise data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getLeavesRoleWise(Long orgId, String monthYear) {
		...
		try {
			...
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch leaves role-wise data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getWeeklyEmployeeStrength(Long orgId) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromUriString(webConstants.getWeeklyEmployeeStrengthUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody()
								: "Failed to fetch weekly employee strength data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getWeeklyWorkingHours(Long orgId) {
		...
		try {
			...
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode()).body(
						response.getBody() != null ? response.getBody() : "Failed to fetch weekly working hours data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
	...
	public ResponseEntity<?> getWeeklyCheckInCheckOut(Long orgId) {
		...
		try {
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromUriString(webConstants.getWeeklyCheckInCheckOutUrl())
					.queryParam("orgId", orgId);
			ResponseEntity<String> response = restService.iamRestCall(builder.toUriString(), null, null, HttpMethod.GET,
					null);
			if (response.getStatusCode().is2xxSuccessful()) {
				...
				return ResponseEntity.status(response.getStatusCode())
						.body(response.getBody() != null ? response.getBody()
								: "Failed to fetch weekly check-in/check-out data");
			}
		} catch (RuntimeException e) {
			throw new ServiceLevelException(
					"AnalyticsService",
